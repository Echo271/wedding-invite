    ...
    <div class="container">
        <div class="row text-center">
            <div class="col">
                ...
                <p class="pt-3">Saudara / Saudari</p>
                <div class="col">
                    <a href="home.html" class="btn text-light" style="background-color: #BD83CE ;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-open-fill" viewBox="0 0 16 16">
